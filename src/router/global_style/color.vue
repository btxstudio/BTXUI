  ...
  <article>
      ...
      <div class="grid pcenter">
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-9 round-sm">alpha-9</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-8 round-sm">alpha-8</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-7 round-sm">alpha-7</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-6 round-sm">alpha-6</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-5 round-sm">alpha-5</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-4 round-sm">alpha-4</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-3 round-sm">alpha-3</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-2 round-sm">alpha-2</div>
        </div>
        <div class="col-4 pad-r-d5 pad-b-d5">
            <div class="bg-color-mgray alpha-1 round-sm">alpha-1</div>
        </div>
      </div>
