<template>
    <article>
        ...
        <section>
            <h5>基础使用</h5>
            <p>通过 <code>selected</code> 属性绑定表单选取数据。其次可以使用 <code>form-data</code> 属性，对表单元素进行常规设置：<b>name</b> 设置数据字段键名、<b>placeholder</b> 设置提示文字、<b>maxlength</b> 设置最大字符数、<b>readonly</b> 内容只读。</p>
        ...
        <section>
            <h5>表单验证</h5>
            <p>通过 <b>input-widget</b> 组件的 <code>rule</code> 属性可设置表单项验证，当执行表单"提交"时会包含验证信息以供回调处理。</p>
            <div class="resize bg-color-lgray pad-v-1 pad-h-2 round-sm">
        ...
        <section>
            <h5>其它表单元素</h5>
            <p>通过 <code>select</code> 属性可设置下拉框表单元素。</p>
            <div class="resize bg-color-lgray pad-v-1 pad-h-2 round-sm">
