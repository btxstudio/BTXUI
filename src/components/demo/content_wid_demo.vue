<template>
    <article>
        <h5><code>content-wid</code></h5>
        <p>该组件用于处理树形结构数据的可视化及交互操作。</p>
        <p>组件依赖：<code>content-node-wid</code>、<code>tooltip-wid</code></p>
        <p>组件初始化入参：</p>
        <p></p>
        ...
        <div class="bg-color-lgray pad-v-1 pad-h-2 round-sm">
            <content-wid :data-tree="dataTree_1" />
        </div>
        <p></p>
        ...
        <div class="bg-color-lgray pad-v-1 pad-h-2 round-sm">
            <content-wid :data-tree="dataTree_2" />
        </div>
        <p></p>
        ...
        <div class="bg-color-lgray pad-v-1 pad-h-2 round-sm">
            <content-wid :data-tree="dataTree_3.data" @on_select="$_select_3" />
        </div>
        <p>当前所选数据：</p>
