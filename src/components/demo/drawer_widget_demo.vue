<template>
    <article>
        ...
        <section>
            <h5>基础使用</h5>
            <p>通过 <code>v-model</code> 可以初始化及双向绑定展开状态。组件交互区域继承自 <b>tag-widget</b> ，可参考相关入参：<code>tagData</code>。</p>
            <div class="resize grid">
                <div class="col-6 pad-r-3 line-r thick-1 line-lgray">
                    <drawer-widget v-bind="data_1" v-model="data_1.selected">
        ...
        <section>
            <h5>风格化</h5>
            <p>组件 <code>tagData</code> 属性 <b>text</b> 字段支持富文本；<b>colors</b> 字段可设置配色风格。<code>iconData</code> 属性则可设置 "抽屉" 图标。</p>
            <div class="resize flex">
                <drawer-widget v-bind="data_2">
...
<script>
    ...
    import DrawerWidget from "@/components/BTXUI/drawer/drawer-widget"

    export default {
        name: "drawer_widget_demo",
        components: {
            HeaderInfo,
            DrawerWidget
        },
        data(){
            return {
                ...
                //初始化入参
                header_info: {
                    name: DrawerWidget.name,
                    ...DrawerWidget.introduce,
                },
