<template>
    <article>
        ...
        <section>
            ...
            <div class="resize">
                <table-widget ref="table_2" v-bind="data_2.props" @on_click="$_show_row_number2" />
                <div class="flex mrg-t-1">
                    <tag-widget @on_click="$_toggle_row_enable2" v-bind="data_2.tag_data" v-model="data_2.enable" />
                </div>
            </div>
            <hr>
            <p></p>
        ...
        <section>
            ...
            <div class="resize">
                <table-widget ref="table_5" v-bind="data_5.props" @on_select="$_select5" />
                <div class="flex mrg-t-1">
                    <tag-widget @on_click="$_toggle_row_select5" v-bind="data_5.tag_data" v-model="data_5.enable" />
                </div>
            </div>
            <p>
                当前所选数据行：
...
<script>
    ...
    import TableWidget from "@/components/BTXUI/table/table-widget"

    export default {
        name: "table_widget_demo",
        components: {
            HeaderInfo,
            TableWidget,
            tagWidget
