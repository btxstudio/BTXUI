<template>
    <article>
        ...
        <section>
            ...
            <div class="flex resize">
                <form-pannel-widget v-model="data_2.pannel_info" v-bind="data_2.props" />
                <btn-widget @on_click="$_toggle_pannel2" btnText="显示表单面板" />
            </div>
            <hr>
            <p></p>
        </section>
        ...
        <section>
            ...
            <div class="flex resize">
                <form-pannel-widget v-model="data_3.pannel_info" v-bind="data_3.props" />
                <btn-widget @on_click="$_toggle_pannel3" btnText="显示表单面板" />
            </div>
            <hr>
            <p></p>
        </section>
        ...
        <section>
            ...
            <div class="flex resize">
                <form-pannel-widget v-model="data_4.pannel_info" v-bind="data_4.props" />
                <btn-widget @on_click="$_toggle_pannel4" btnText="显示表单面板" />
            </div>
    ...
    export default {
        ...
        data(){
            return {
                ...
                //初始化入参
                header_info: {
                    name: FormPannelWidget.name,
                    ...FormPannelWidget.introduce,
                },
