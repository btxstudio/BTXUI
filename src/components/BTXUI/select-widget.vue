<template>
    <div :class="`select-widget relative ${state? 's-w-spread': ''}`">
        ...
        <ul class="s-w-list hide bg-color-light round-sm mrg-t-1 z9 absolute shadow-lg color-mgray auto-scroll max-w" :style="list_left_offset" ref="$list">
            <li v-for="item of data_list"
                ...
                <div class="pad-l-1d5">
                    <b class="s-w-dot absolute lx1 color-mgray alpha-4">·</b>
