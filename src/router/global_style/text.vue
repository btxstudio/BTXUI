<template>
  <article>
    ...
    <p>预置的字号比率值：0.1 — 0.9、1.1 — 1.9、2、2.5、3、3.5、4、4.5、5、5.5，单位 em。数值 "." 使用 "d" 代替，"0" 使用 "" 空字符串代替。比如缩小为 0.9 倍，类名为 <code>.fsize-d9</code>。</p>
    <p>【示例】：</p>
    ...
    <p>【示例】：</p>
    <p><abbr title="javascript 和 php 谁是世界上最好的语言呢？" class="ellipsis w-15">javascript 和 php 谁是世界上最好的语言呢？</abbr></p>
    <p></p>
